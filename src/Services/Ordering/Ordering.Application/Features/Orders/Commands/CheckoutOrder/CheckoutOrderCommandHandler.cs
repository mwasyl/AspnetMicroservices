...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        {
            var email = new Email() {To = "111@gmail.com", Body = $"Order was created.", Subject = "Order was created"};
            ...
            {
                _logger.LogError($"Order {order.Id} mail failed due to an error with the email service: {ex.Message}");
            }
        }
    }
}